...
\include{Sections/2. Results/Metropolis Hastings/1. Bayesian Inference/Introduction_to_Bayesian_inference}

\include{Sections/2. Results/Metropolis Hastings/2. Markov Chains/convergence}
